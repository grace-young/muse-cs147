 ...
 */
public class AllStripAdapter extends RecyclerView.Adapter<AllStripAdapter.ViewHolder> {
// some kind of private var here ??????
    ...
    @Override
    public AllStripAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTextView.setText(mDatasetStrip.get(position).getStripTitle());
